...
public class Global extends GlobalSettings {
    ...
    public static class SpringDataJpaConfiguration {
    	...
    	public Jaxb2Marshaller marshaller() {
    		...
    		//String[] packages = {"com.cdyne.ws.weatherws"};
    		marshaller.setClassesToBeBound(ObjectFactory.class, ArrayOfForecast.class, ArrayOfWeatherDescription.class, 
    				Forecast.class, ForecastReturn.class, GetCityForecastByZIP.class, 
    				GetCityForecastByZIPResponse.class, GetCityWeatherByZIP.class, 
    				GetCityWeatherByZIPResponse.class, GetWeatherInformation.class,
    				GetWeatherInformationResponse.class, POP.class, WeatherDescription.class, 
    				Temp.class,
    				WeatherReturn.class);
    		return marshaller;
    	}
    	...
    	@Bean
    	public WebserviceInteraction webserviceInteraction(Jaxb2Marshaller marshaller) {
    		WebserviceInteraction client = new WebserviceInteraction();
